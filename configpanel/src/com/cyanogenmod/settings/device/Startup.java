...
public class Startup extends BroadcastReceiver {
    ...
    private boolean hasTouchscreenGestures() {
        return new File(Constants.TOUCHSCREEN_C_GESTURE_NODE).exists() &&
            new File(Constants.TOUCHSCREEN_E_GESTURE_NODE).exists() &&
            new File(Constants.TOUCHSCREEN_S_GESTURE_NODE).exists() &&
            new File(Constants.TOUCHSCREEN_V_GESTURE_NODE).exists() &&
            new File(Constants.TOUCHSCREEN_W_GESTURE_NODE).exists() &&
            new File(Constants.TOUCHSCREEN_Z_GESTURE_NODE).exists();
    }
